...
class FixFixerHelpFrame(wx.Frame):
    ...
    def __init__(self, *args, **kwds):
        ...
        self.HelpIcon = wx.Icon("fix-fixer.ico", wx.BITMAP_TYPE_ICO)
        self.HomeIcon = wx.Bitmap("home.png", wx.BITMAP_TYPE_ANY)
        self.PrevIcon = wx.Bitmap("prev.png", wx.BITMAP_TYPE_ANY)
        self.NextIcon = wx.Bitmap("next.png", wx.BITMAP_TYPE_ANY)
