...
class FixFixerFrame(wx.Frame):
	def __init__(self, *args, **kwds):
		...
		self.FileMenu_Template = wx.MenuItem(self.FileMenu, 3, "Create &Template", "Create a message using a wizard", wx.ITEM_NORMAL)
		self.FileMenu_LoadTemplate = wx.MenuItem(self.FileMenu, 4, "Load T&emplate", "Load a previously created template", wx.ITEM_NORMAL)
		...
		self.FileMenu.AppendItem(self.FileMenu_Template)
		self.FileMenu.AppendItem(self.FileMenu_LoadTemplate)
		self.FileMenu.AppendSeparator()
	...
	def __do_bindings(self):
		...
		self.Bind(wx.EVT_MENU, self.onDoTemplate, self.FileMenu_Template)
...
# ----- Events --------------------------------------------------------------- #
	...
	def onDoTemplate(self, event):
		...
		if dialog.ShowModal() == False:
			return 0
		dialog.Destroy()
		person_tags = fixfixer_customtemplate.create(self)
		person_tags.ShowModal()
		tags = person_tags.editableListBox1.Strings
		for tag in tags:
			print tag
#
...
#				print "Template 2 returns: " + str(result2)
#				if result2 == 2:
#					return
#				template3 = fixfixer_template3.create(self)
#				template3.Center()
#				result3 = template3.ShowModal()
#				print "Template 3 returns: " + str(result3)
#				if result3 == 3:
#					return
#		dialog = wx.MessageDialog(self, "More wizards are in the works...so please be patient!", "Huh? What's next?", wx.CANCEL|wx.OK|wx.ICON_INFORMATION)
#		dialog.ShowModal()
#		dialog.Destroy()
#		
# ---------------------------------------------------------------------------- #
