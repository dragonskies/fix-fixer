...
class FixActionHistory():
	...
	applications history.  Handles requests to add, clear, and query the history."""
	...
	def Undo(self):
		"""When Undo() is called, perform the action and append it to Redo, enabling
		and disabling each as needed."""
		try:
	...
	def Redo(self):
		"""When Redo() is called, perform the action and append it to Undo, enabling
		and disabling each as needed."""
		try:
	...
	def StartAdd(self, name, data):
		"""StartAdd() is used to begin adding data when only part of it is available."""
