...
class Dialog1(wx.Dialog):
	...
	def GetSecurityData(self):
		...
		for i in range(page_count):
			...
			tag_65="65="+page.textCtrl2.GetValue()
			tag_460="460="+page.textCtrl3.GetValue()
			tag_167="167="+page.textCtrl4.GetValue()
			date_selected = page.datePickerCtrl1.GetValue()
			tag_541="541="+str(date_selected.GetYear())+str(date_selected.GetMonth())+str(date_selected.GetDay())
			tag_876="876="+str(page.numCtrl1.GetValue())
			message = message + tag_55 + soh + tag_65 + soh +tag_460+ soh + tag_167 + soh + tag_541 + soh + tag_876 + soh
		tag_146="146="+str(i)
		security_message =tag_146 + soh + message
